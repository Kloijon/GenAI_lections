...
from .tool_directorywatcher import DirectoryWatcherTool
...
class LLMAgent:
    ...
    def __init__(self, model: str = "tngtech/deepseek-r1t2-chimera", local: bool = False, 
        ...
        self.tools = {
            ...
            "directory_watcher": DirectoryWatcherTool(),
        }
    ...
    def _ask_llm_for_plan(self, query: str) -> List[Dict]:
        ...
        - **directory_watcher**: For tracking real-time changes in a local directory (file/folder creation, deletion, modification, and moving). Use it with a directory path. Optionally specify a duration in seconds to limit monitoring time (useful for tests and CI). USE ONLY LOCAL PATHS.
